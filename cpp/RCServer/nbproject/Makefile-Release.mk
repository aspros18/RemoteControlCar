...
${OBJECTDIR}/BooleanPartialControllerData.o: BooleanPartialControllerData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BooleanPartialControllerData.o BooleanPartialControllerData.cpp

${OBJECTDIR}/BooleanPartialHostData.o: BooleanPartialHostData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BooleanPartialHostData.o BooleanPartialHostData.cpp
...
${OBJECTDIR}/ControllerData.o: ControllerData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControllerData.o ControllerData.cpp

${OBJECTDIR}/ControllerSideDisconnectProcess.o: ControllerSideDisconnectProcess.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControllerSideDisconnectProcess.o ControllerSideDisconnectProcess.cpp

${OBJECTDIR}/ControllerSideMessageProcess.o: ControllerSideMessageProcess.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControllerSideMessageProcess.o ControllerSideMessageProcess.cpp
...
${OBJECTDIR}/ControllerStorage.o: ControllerStorage.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControllerStorage.o ControllerStorage.cpp
...
${OBJECTDIR}/HostData.o: HostData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HostData.o HostData.cpp

${OBJECTDIR}/HostList.o: HostList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HostList.o HostList.cpp

${OBJECTDIR}/HostNamePartialControllerData.o: HostNamePartialControllerData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HostNamePartialControllerData.o HostNamePartialControllerData.cpp

${OBJECTDIR}/HostSideDisconnectProcess.o: HostSideDisconnectProcess.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HostSideDisconnectProcess.o HostSideDisconnectProcess.cpp
...
${OBJECTDIR}/HostStatePartialControllerData.o: HostStatePartialControllerData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HostStatePartialControllerData.o HostStatePartialControllerData.cpp
...
${OBJECTDIR}/OfflineChangeablePartialControllerData.o: OfflineChangeablePartialControllerData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OfflineChangeablePartialControllerData.o OfflineChangeablePartialControllerData.cpp

${OBJECTDIR}/PartialHostList.o: PartialHostList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PartialHostList.o PartialHostList.cpp

${OBJECTDIR}/PointPartialHostData.o: PointPartialHostData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointPartialHostData.o PointPartialHostData.cpp
